        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-title">
                    ...
                    action="{{ route('admin.product.search') }}" method="post">
                    @csrf
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        @foreach ($products as $product)
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            ...
                                            <a href="" class="text-gray-800 text-hover-primary fs-5 fw-bolder"
                                                data-kt-ecommerce-product-filter="product_name">{{ $product->title['uz'] }}</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">{{ $product->product_category->title['uz'] }}</span>
                                </td>
