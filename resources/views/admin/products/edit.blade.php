                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title[{{ $language->small }}]"
                                                    ...
                                                    @if ($language->small != 'en') @else value="{{ $product->title[$language->small] }}" @endif />
                                            ...
                                            <div>
                                                ...
                                                <textarea id="descriptions-{{ $language->small }}" name="descriptions[{{ $language->small }}]"
                                                    class="form-control ckeditor" required> @if ($language->small != 'en')
@else{!! $product->descriptions[$language->small] !!}
@endif </textarea>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" data-control="select2" name="product_category_id"
                                ...
                                <option value="{{ $product->category_id }}" selected="false" disabled="disabled">
                                    {{ $product->product_category->title['uz'] }}</option>
                                @foreach ($categories as $category)
                                    @if ($category->product_categories->isNotEmpty())
                                        <option value="{{ $category->title['uz'] }}">{{ $category->title['uz'] }}
