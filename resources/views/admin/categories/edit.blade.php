...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="" action="{{ route('admin.categories.update', $category->id) }}" method="POST"
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="tab-content">
                        @foreach ($languages as $language)
                            <!--begin::Tab pane-->
                            <div class="tab-pane fade show @if ($language->small != 'uz') @else
                            active @endif"
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title[{{ $language->small }}]"
                                                    ...
                                                    @if ($language->small != 'uz') @else value="{{ $category->title[$language->small] }}" @endif />
                                            ...
                                            <div>
                                                ...
                                                <textarea id="descriptions-{{ $language->small }}" required name="descriptions[{{ $language->small }}]"
                                                    class="form-control ckeditor"> @if ($language->small != 'uz')
@else{!! $category->descriptions[$language->small] !!}
@endif
</textarea>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <select class="form-select mb-2" data-control="select2" name="category_id"
                                ...
                                <option value="{{ $category->category_id }}" selected="false" disabled="disabled">
                                    {{ $category->title['uz'] }}</option>
                        ...
                        <div class="card-body  pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
                                style="background-image: url({{ asset($category->photo) }})">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" data-control="select2" name="status" data-hide-search="true"
                                ...
                                <option value="{{ $category->status }}" selected="false" disabled="disabled">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <input type="number" name="order" id="checkbox" value="{{ $category->order }}"
                        ...
                        <div class="card-body pt-0">
                            ...
                            <input type="checkbox" name="popular" class="custom-switch-input"
                                {{ $category->popular == 'active' ? 'checked' : '' }}>
