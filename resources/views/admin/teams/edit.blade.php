...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="" action="{{ route('admin.teams.update', $team->id) }}" method="post"
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input required type="text" name="job_title[{{ $language->small }}]"
                                                    ...
                                                    placeholder="job_title {{ $language->small }}..."
                                                    value="{{ $team->job_title[$language->small] }}" />
                                            ...
                                            <div>
                                                ...
                                                <textarea required name="descriptions[{{ $language->small }}]" class="form-control ckeditor" required>{!! $team->descriptions[$language->small] !!}</textarea>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body  pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
                                style="background-image: url({{ asset($team->photo) }})">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <input type="text" class="form-control mb-2" name="tel_number"
                                value="{{ $team->tel_number }}" required>
                        </div>
                        <div class="card-body pt-0">
                            <!--begin::Select store template-->
                            ...
                            <input type="text" class="form-control mb-2" name="telegram_nickname"
                                value="{{ $team->telegram_nickname }}" required>
                        </div>
                        <div class="card-body pt-0">
                            <!--begin::Select store template-->
                            <label for="kt_ecommerce_add_category_store_template" class="form-label">Add instagram</label>
                            <input type="text" class="form-control mb-2" name="instagram" value="instagram" required>
                        </div>
                    </div>
                </div>
            </form>
