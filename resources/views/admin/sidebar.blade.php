            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item{{ Request::routeIs('admin.z.index') ? ' here  menu-accordion' : '' }} ">
                    ...
                    <div data-kt-menu-trigger="click"
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            {{-- <div class="menu-item">
                                <a class="menu-link {{ Request::routeIs('admin.teams.index') ? 'active' : '' }}" href="{{ route('admin.teams.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{ Request::routeIs('admin.otzivi.index') ? 'active' : '' }}" href="{{ route('admin.otzivi.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Otzivi</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link {{ Request::routeIs('admin.faq.index') ? 'active' : '' }}" href="{{ route('admin.faq.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{ Request::routeIs('admin.sertificates.index') ? 'active' : '' }}" href="{{ route('admin.sertificates.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            {{-- <div class="menu-item">
                                <a class="menu-link {{ Request::routeIs('admin.information.index',1) ? 'active' : '' }}" href="{{ route('admin.information.index',1) }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
