...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="" action="{{ route('admin.otzivi.update', $otzivi->id) }}" method="post"
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input required type="text" name="FIO[{{ $language->small }}]"
                                                    ...
                                                    value="{{ $otzivi->FIO[$language->small] }}" />
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input required type="text" name="job_title[{{ $language->small }}]"
                                                    ...
                                                    value="{{ $otzivi->job_title[$language->small] }}" />
                                            ...
                                            <div>
                                                ...
                                                <textarea id="descriptions-{{ $language->small }}" required name="descriptions[{{ $language->small }}]" class="form-control ckeditor" required>{!! $otzivi->descriptions[$language->small] !!}</textarea>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body  pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
                                style="background-image: url({{ asset($otzivi->photo) }})">
