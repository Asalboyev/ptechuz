                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input required type="text" name="question[{{ $language->small }}]"
                                                    class="form-control mb-2" placeholder=" {{ $language->small }}..." />
                                            ...
                                            <div class="">
                                                ...
                                                <textarea id="answer-{{ $language->small }}" required name="answer[{{ $language->small }}]" class="form-control ckeditor"></textarea>
