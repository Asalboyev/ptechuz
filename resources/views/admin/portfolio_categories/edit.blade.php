...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="" action="{{ route('admin.portfolio_categories.update', $portfolio_category->id) }}" method="POST"
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div>
                                                ...
                                                <textarea name="descriptions[{{ $language->small }}]" class="form-control ckeditor" required> @if ($language->small != 'uz')@else{!! $portfolio_category->descriptions[$language->small] !!}@endif </textarea>
